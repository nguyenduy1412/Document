...
.btn-dangky a{
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light">
    ...
    <main class="color-form bg-light p-5">
      <div class="form-login ">
          <h3 class="text-center">Thông tin đăng đăng ký</h3>
          <form:form action="../editAccount" method="post" modelAttribute="acc">
              <div class="form-group">
                  <form:input type="text" placeholder="Tên đăng nhập" class="form-control" path="userName" readonly="true"  />
                  
                  <div class="err"><span id="err_name"></span></div>
              </div>
              
              <div class="form-group">
                  <form:input type="password" placeholder="Mật khẩu mới" class="form-control" id="pass" path="passWord" />
