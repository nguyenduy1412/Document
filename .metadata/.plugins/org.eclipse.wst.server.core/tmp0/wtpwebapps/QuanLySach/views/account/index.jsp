  ...
  <%@ include file="../menu.jsp" %>
    <div class="container">
      <div class="row d-flex justify-content-center">
        ...
        <a href="insertAccount" class="btn btn-success">Thêm mới</a>
          <table class="table">
            <thead>
              <tr>
                <th>Tên đăng nhập</th>
            ...
            <c:forEach items="${list }" var ="c">
              <tr>
                ...
                <td>${c.passWord }</td>
                <td><a href="updateAccount/${c.userName}" class="btn btn-primary">Update</a></td>
                <td><a href="deleteAccount/${c.userName}" class="btn btn-danger">Delete</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
