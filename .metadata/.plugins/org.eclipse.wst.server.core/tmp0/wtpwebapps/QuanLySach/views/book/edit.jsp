           ...
           <c:if test ="${!empty error}">
			<div class="alert alert-danger alert-dismissible">
			  ...
			  <strong>${error}!</strong>
                ...
                <form:form action="../updateBook" method="POST" modelAttribute="book" enctype="multipart/form-data">
					  
					  <div class="form-group">
					  <form:input type="hidden" path="bookId" class="form-control"/>
					  <form:input type="hidden" path="img" class="form-control"/>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <form:select path="category.categoryId" class="form-control">
					    	<form:options items="${listCategory}" class="form-control" itemLabel="categoryName" itemValue="categoryId" />
					    </form:select>
					  </div>
					    <label for="exampleInputEmail1">Giá</label>
					    <input type="text" name="price" value="<fmt:formatNumber type="number" maxFractionDigits="3" value="${book.price}"/>" class="form-control">		    
					  </div>
					<div class="form-group">
					    <label for="exampleInputEmail1">Ảnh</label>
					    <input type="file" name="fileImage" class="form-control">
					 	<img alt="" src="${pageContext.request.contextPath}/<c:url value="uploads"/>/${pageContext.request.contextPath}/recources/images/${book.img}" width="100px">
					  </div>
